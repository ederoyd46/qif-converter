...
release-all-architectures:
	...
	GOOS='linux' GOARCH='arm64' go build -ldflags "-w" -o target/qif-converter-linux-arm64 .
	GOOS='darwin' GOARCH='amd64' go build -ldflags "-w" -o target/qif-converter-darwin-amd64 .
	GOOS='darwin' GOARCH='arm64' go build -ldflags "-w" -o target/qif-converter-darwin-arm64 .
	GOOS='windows' GOARCH='amd64' go build -ldflags "-w" -o target/qif-converter-windows-amd64.exe .
	GOOS='windows' GOARCH='arm64' go build -ldflags "-w" -o target/qif-converter-windows-arm64.exe .
